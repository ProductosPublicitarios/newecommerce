...
$s = 'SELECT count(id) tot FROM novedades';
$r = mysql_query($s);
if($r){
	...
	$l_ini = $p!=0?($p-1)*Q:0;
	$limit = "LIMIT $l_ini,".Q;
	$s = "SELECT * FROM novedades $w $order $limit";
	$r = mysql_query($s);
	if($r){
		$q = mysql_num_rows($r);
		if($r>0){
...
<div id='cont'>
    ...
    <div id="contenidos">
    <div id="submenu">
    	Pagina <select id="page" onchange="changePage('novedades');"><?php echo $options_page; ?></select> de <?php echo $page_total; ?>
    </div>
    <br />
    <table width="100%" cellpadding="3" cellspacing="1" border="0">
        ...
        <tr>
            ...
            <td align="center"><a href="novedades_ver.php?id=<?php echo $v['id']; ?>">ver</a></td>
            <td align="center"><a href="novedades_editar.php?id=<?php echo $v['id']; ?>">editar</a></td>
            <td align="center"><a href="novedades_borrar.php?id=<?php echo $v['id']; ?>">borrar</a></td>
        </tr>
        <?php }} ?>
    </table>
    </div>
