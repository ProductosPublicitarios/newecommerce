...
function nuMail($de, $deMail, $paraMail, $cc, $cco, $asunto, $body, $bodyAlt='')
{
  $mail = new phpmailer();
  $mail->PluginDir = "./";
  $mail->Mailer = "mail";
...
function nuMail2($de, $deMail, $paraMail, $cc, $cco, $asunto, $body, $bodyAlt='', $attach=false, $attach_name=false)
{
  $mail = new phpmailer();
  $mail->PluginDir = "./";
  $mail->Mailer = "mail";
  /*$mail->Mailer = "smtp";
  $mail->Host = "smtp.gylenterprise.com.ar";
  $mail->SMTPAuth = true;
  $mail->Username = ""; 
  $mail->Password = "";*/
